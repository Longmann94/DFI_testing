...
class Test_setUp_menu_buttons(unittest.TestCase):   
    ...
    #@unittest.skip("skip")
    def test_TC_Hearing_01_iconClick(self):
        driver = self.driver
        driver.get(url)
        time.sleep(2)
        ...
        self.assertTrue(driver.find_element_by_id("hear").is_selected())
        self.assertTrue(driver.find_element_by_id("deaf").is_selected())
        self.assertTrue(driver.find_element_by_id("hardhear").is_selected())

        driver.save_screenshot('SC_TC_Hearing_01_iconClick.png')
        
        
    #@unittest.skip("skip")    
    def test_TC_Hearing_01_checkboxClick(self):
        driver = self.driver
        driver.get(url)
        time.sleep(2)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        ...
        self.assertTrue(driver.find_element_by_id("deaf").is_selected())
        self.assertTrue(driver.find_element_by_id("hardhear").is_selected())       
        driver.save_screenshot('SC_TC_Hearing_01_checkboxClick.png')
        
        
    #@unittest.skip("skip")
    def test_TC_Hearing_01_textClick(self):
        driver = self.driver
        driver.get(url)
        time.sleep(2)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        ...
        self.assertTrue(driver.find_element_by_id("deaf").is_selected())
        self.assertTrue(driver.find_element_by_id("hardhear").is_selected())
        driver.save_screenshot('SC_TC_Hearing_01_textClick.png')
        
        
    #@unittest.skip("skip")    
    def test_TC_Hearing_01_boxAreaClick(self):
        driver = self.driver
        driver.get(url)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        driver.find_element_by_xpath("//div[@id='wrapper']/div[8]/div/button/div[2]").click()
    ...
    def test_TC_Hearing_05(self):
        ...
        time.sleep(2)
        # assertEqual()
        driver.save_screenshot('SC_TC_Hearing_05.png') 
