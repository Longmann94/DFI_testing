...
class Test_setUp_menu_buttons(unittest.TestCase):   
    ...
    def test_TC_UsingKeyboardandMouse_01_checkboxClick(self):
        ...
        Select(driver.find_element_by_xpath("//div[@id='setupContainer']/div[2]/select")).select_by_visible_text("Claustrophobic")
        driver.find_element_by_xpath("//img[@alt='setup icon']").click()
        driver.find_element_by_xpath("//div[@id='setup2']/ul/div[19]/li/label/span").click()      
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("tableserv").is_selected())
    ...
    def test_TC_UsingKeyboardandMouse_01_textClick(self):
        ...
        Select(driver.find_element_by_xpath("//div[@id='setupContainer']/div[2]/select")).select_by_visible_text("Claustrophobic")
        driver.find_element_by_xpath("//img[@alt='setup icon']").click()
        driver.find_element_by_xpath("//div[@id='setup2']/ul/div[19]/li/label").click()
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("tableserv").is_selected())
    ...
    def test_TC_UsingKeyboardandMouse_01_boxAreaClick(self):
        ...
        Select(driver.find_element_by_xpath("//div[@id='setupContainer']/div[2]/select")).select_by_visible_text("Claustrophobic")
        driver.find_element_by_xpath("//img[@alt='setup icon']").click()
        driver.find_element_by_xpath("//div[@id='setup2']/ul/div[19]/li").click()
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("tableserv").is_selected())
    ...
    def test_TC_UsingKeyboardandMouse_04(self):
        ...
        button = driver.find_element_by_xpath("//div[@id='setup2']/ul/div[19]/li/label")
