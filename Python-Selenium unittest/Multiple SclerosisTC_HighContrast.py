...
class Test_setUp_menu_buttons(unittest.TestCase):   
    ...
    #@unittest.skip("skip")
    def test_TC_HighContrast01_iconClick(self):
        driver = self.driver
        driver.get(url)
        time.sleep(2)
        ...
        driver.save_screenshot('SC_TC_HighContrast01_iconClick.png')
        
        
    #@unittest.skip("skip")    
    def test_TC_HighContrast01_checkboxClick(self):
        driver = self.driver
        driver.get(url)
        time.sleep(2)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        ...
        driver.find_element_by_xpath("//img[@alt='setup icon']").click()
        driver.find_element_by_xpath("//img[@alt='Seeing clearly']").click()
        driver.find_element_by_xpath("//div[@id='setup1']/ul/div[8]/li/label/span").click()      
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("morecontrast").is_selected())
        driver.save_screenshot('SC_TC_HighContrast01_checkboxClick.png')
        
        
    #@unittest.skip("skip")
    def test_TC_HighContrast01_textClick(self):
        driver = self.driver
        driver.get(url)
        time.sleep(2)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        ...
        driver.find_element_by_xpath("//img[@alt='setup icon']").click()
        driver.find_element_by_xpath("//img[@alt='Seeing clearly']").click()
        driver.find_element_by_xpath("//div[@id='setup1']/ul/div[8]/li/label").click()
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("morecontrast").is_selected())
        driver.save_screenshot('SC_TC_HighContrast01_textClick.png')
        
        
    #@unittest.skip("skip")    
    def test_TC_HighContrast01_boxAreaClick(self):
        driver = self.driver
        driver.get(url)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        driver.find_element_by_xpath("//div[@id='wrapper']/div[8]/div/button/div[2]").click()
        ...
        driver.find_element_by_xpath("//img[@alt='setup icon']").click()
        driver.find_element_by_xpath("//img[@alt='Seeing clearly']").click()
        driver.find_element_by_xpath("//div[@id='setup1']/ul/div[8]/li").click()
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("morecontrast").is_selected())
        driver.save_screenshot('SC_TC_HighContrast01_boxAreaClick.png')
       
        
    #@unittest.skip("skip")
    def test_TC_HighContrast02a(self):
        driver = self.driver
        driver.get(url)
        time.sleep(2)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        ...
        driver.find_element_by_xpath("//img[@alt='I Need High Contrast']").click()
        time.sleep(2)
        self.assertFalse(driver.find_element_by_id("morecontrast").is_selected())
        driver.save_screenshot('SC_TC_HighContrast02a_unselect.png')
    ...
    #@unittest.skip("skip")     
    def test_TC_HighContrast02b(self):
        driver = self.driver
        driver.get(url)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        driver.find_element_by_xpath("//div[@id='wrapper']/div[8]/div/button/div[2]").click()
        ...
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("morecontrast").is_selected())
        driver.save_screenshot('SC_TC_HighContrast02b_select.png')  
        
        
    #@unittest.skip("skip")    
    def test_TC_HighContrast03(self):
        driver = self.driver
        driver.get(url)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        driver.find_element_by_xpath("//div[@id='wrapper']/div[8]/div/button/div[2]").click()
    ...
    def test_TC_HighContrast04(self):
        ...
        driver.find_element_by_xpath("//img[@alt='setup icon']").click()
        driver.find_element_by_xpath("//img[@alt='Seeing clearly']").click()
        driver.find_element_by_xpath("//img[@alt='I Need High Contrast']")
        button = driver.find_element_by_xpath("//div[@id='setup1']/ul/div[8]/li/label")
        ActionChains(driver).drag_and_drop_by_offset(button, 30, 10).perform()
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("morecontrast").is_selected())
        # assertEqual()
        driver.save_screenshot('SC_TC_HighContrast04.png')
        
        
    #@unittest.skip("skip")   
    def test_TC_HighContrast05(self):
        driver = self.driver          
        driver.get(url)
        time.sleep(2)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        ...
        time.sleep(2)
        # assertEqual()
        driver.save_screenshot('SC_TC_HighContrast05.png') 
