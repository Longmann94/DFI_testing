...
class Test_setUp_menu_buttons(unittest.TestCase):   
    ...
    #@unittest.skip("skip")
    def test_TC_UsingWalker01_iconClick(self):
        driver = self.driver
        driver.get(url)
        time.sleep(2)
        ...
        driver.save_screenshot('SC_TC_UsingWalker01_iconClick.png')
        
        
    #@unittest.skip("skip")    
    def test_TC_UsingWalker01_checkboxClick(self):
        driver = self.driver
        driver.get(url)
        time.sleep(2)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        ...
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("walker").is_selected())
        driver.save_screenshot('SC_TC_UsingWalker01_checkboxClick.png')
        
        
    #@unittest.skip("skip")
    def test_TC_UsingWalker01_textClick(self):
        driver = self.driver
        driver.get(url)
        time.sleep(2)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        ...
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("walker").is_selected())
        driver.save_screenshot('SC_TC_UsingWalker01_textClick.png')
        
        
    #@unittest.skip("skip")    
    def test_TC_UsingWalker01_boxAreaClick(self):
        driver = self.driver
        driver.get(url)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        driver.find_element_by_xpath("//div[@id='wrapper']/div[8]/div/button/div[2]").click()
        ...
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("walker").is_selected())
        driver.save_screenshot('SC_TC_UsingWalker01_boxAreaClick.png')
       
        
    #@unittest.skip("skip")
    def test_TC_UsingWalker02a(self):
        driver = self.driver
        driver.get(url)
        time.sleep(2)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        ...
        driver.find_element_by_xpath("//img[@alt='Using a Walker']").click()
        time.sleep(2)
        self.assertFalse(driver.find_element_by_id("walker").is_selected())
        driver.save_screenshot('SC_TC_UsingWalker02a_unselect.png')
    ...
    #@unittest.skip("skip")     
    def test_TC_UsingWalker02b(self):
        driver = self.driver
        driver.get(url)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        driver.find_element_by_xpath("//div[@id='wrapper']/div[8]/div/button/div[2]").click()
        ...
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("walker").is_selected())
        driver.save_screenshot('SC_TC_UsingWalker02b_select.png')  
        
        
    #@unittest.skip("skip")    
    def test_TC_UsingWalker03(self):
        driver = self.driver
        driver.get(url)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        driver.find_element_by_xpath("//div[@id='wrapper']/div[8]/div/button/div[2]").click()
    ...
    def test_TC_UsingWalker04(self):
        ...
        driver.find_element_by_xpath("//img[@alt='setup icon']").click()
        driver.find_element_by_xpath("//img[@alt='Walking']").click()
        driver.find_element_by_xpath("//img[@alt='Using a Walker']")
        ...
        self.assertTrue(driver.find_element_by_id("walker").is_selected())
        # assertEqual()
        driver.save_screenshot('SC_TC_UsingWalker04.png')
        
        
    #@unittest.skip("skip")   
    def test_TC_UsingWalker05(self):
        driver = self.driver          
        driver.get(url)
        time.sleep(2)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        ...
        time.sleep(2)
        # assertEqual()
        driver.save_screenshot('SC_TC_UsingWalker05.png') 
