...
class Test_setUp_menu_buttons(unittest.TestCase):   
    ...
    #@unittest.skip("skip")
    def test_TC_IamDeaf01_iconClick(self):
        driver = self.driver
        driver.get(url)
        time.sleep(2)
        ...
        driver.find_element_by_xpath("//img[@alt='I am Deaf']").click()
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("deaf").is_selected())
        
        driver.save_screenshot('SC_TC_IamDeaf01_iconClick.png')
        
        
    #@unittest.skip("skip")    
    def test_TC_IamDeaf01_checkboxClick(self):
        driver = self.driver
        driver.get(url)
        time.sleep(2)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        ...
        driver.find_element_by_xpath("//img[@alt='setup icon']").click()
        driver.find_element_by_xpath("//img[@alt='Hearing']").click()
        driver.find_element_by_xpath("//div[@id='setup1']/ul/div[16]/li/label/span").click()      
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("deaf").is_selected())
        driver.save_screenshot('SC_TC_IamDeaf01_checkboxClick.png')
        
        
    #@unittest.skip("skip")
    def test_TC_IamDeaf01_textClick(self):
        driver = self.driver
        driver.get(url)
        time.sleep(2)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        ...
        driver.find_element_by_xpath("//img[@alt='setup icon']").click()
        driver.find_element_by_xpath("//img[@alt='Hearing']").click()
        driver.find_element_by_xpath("//div[@id='setup1']/ul/div[16]/li/label").click()
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("deaf").is_selected())
        driver.save_screenshot('SC_TC_IamDeaf01_textClick.png')
        
        
    #@unittest.skip("skip")    
    def test_TC_IamDeaf01_boxAreaClick(self):
        driver = self.driver
        driver.get(url)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        driver.find_element_by_xpath("//div[@id='wrapper']/div[8]/div/button/div[2]").click()
        ...
        driver.find_element_by_xpath("//img[@alt='setup icon']").click()
        driver.find_element_by_xpath("//img[@alt='Hearing']").click()
        driver.find_element_by_xpath("//div[@id='setup1']/ul/div[16]/li").click()
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("deaf").is_selected())
        driver.save_screenshot('SC_TC_IamDeaf01_boxAreaClick.png')
       
        
    #@unittest.skip("skip")
    def test_TC_IamDeaf02a(self):
        driver = self.driver
        driver.get(url)
        time.sleep(2)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        ...
        driver.find_element_by_xpath("//img[@alt='I am Deaf']").click()
        time.sleep(2)
        self.assertFalse(driver.find_element_by_id("deaf").is_selected())
        driver.save_screenshot('SC_TC_IamDeaf02a_unselect.png')
    ...
    def test_TC_IamDeaf02b(self):
        ...
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("deaf").is_selected())
        driver.save_screenshot('SC_TC_IamDeaf02b_select.png')  
        
        
    #@unittest.skip("skip")    
    def test_TC_IamDeaf03(self):
        driver = self.driver
        driver.get(url)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        driver.find_element_by_xpath("//div[@id='wrapper']/div[8]/div/button/div[2]").click()
    ...
    def test_TC_IamDeaf04(self):
        ...
        driver.find_element_by_xpath("//img[@alt='setup icon']").click()
        driver.find_element_by_xpath("//img[@alt='Hearing']").click()
        driver.find_element_by_xpath("//img[@alt='I am Deaf']")
        button = driver.find_element_by_xpath("//div[@id='setup1']/ul/div[16]/li/label")
        ActionChains(driver).drag_and_drop_by_offset(button, 30, 10).perform()
        time.sleep(2)
        self.assertTrue(driver.find_element_by_id("deaf").is_selected())
        # assertEqual()
        driver.save_screenshot('SC_TC_IamDeaf04.png')
        
        
    #@unittest.skip("skip")   
    def test_TC_IamDeaf05(self):
        driver = self.driver          
        driver.get(url)
        time.sleep(2)
        driver.find_element_by_xpath("//div[@id='firsttime']/div[2]/button/div[2]").click()
        ...
        time.sleep(2)
        # assertEqual()
        driver.save_screenshot('SC_TC_IamDeaf05.png') 
