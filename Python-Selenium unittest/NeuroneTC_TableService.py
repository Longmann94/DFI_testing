...
class Test_setUp_menu_buttons(unittest.TestCase):   
    ...
    def test_TC_TableService_01_iconClick(self):
        ...
        driver.find_element_by_xpath("//div[@id='setup3']/ul/div[4]/select").click()
        Select(driver.find_element_by_xpath("//div[@id='setup3']/ul/div[4]/select")).select_by_visible_text("Neurone")
